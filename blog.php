        ...
        <div class="collapse navbar-collapse" id="navbarcollapseCMS">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <form class="form-inline d-none d-sm-block" action="blog.php">
                    ...
                    <button class="btn btn-primary" name="SearchButton">Idź</button>
                </div>
                </form>
            ...
            ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <?php if(strlen($PostText)>200){$PostText = substr($PostText,0,200).'...';}?>
                            <p class="card-text"><?php echo $PostText; ?></p>
                            <a href="FullPost.php?id=<?php echo $id; ?> " style="float:right;"><span class="btn btn-info">Więcej >></span></a>
                        </div>
                    </div>
<?php } ?>
            </div>
